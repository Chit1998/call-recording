package com.cds.callrecording.Utils;
...
import com.cds.callrecording.MainActivity;
...
//        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), (int) R.layout.layout_incoming_call_notification);
        ...
        String contactName = ContactHelper.getContactName(context, handle == null ? null : handle.getSchemeSpecificPart(), true);
...
//        remoteViews.setViewVisibility(R.id.imageViewAnswer,  call.getState() == Call.STATE_RINGING ? View.VISIBLE : View.GONE);
        ...
        String[] retrieveContactPhotoUriAndDisplayName = ContactHelper.ContactPhotoUriAndDisplayName(context, handle.getSchemeSpecificPart());
...
//        } else {
//            intent.setClass(context, CallActivity.class);
//            intent.putExtra("state", TelecomUtils.startCall);
//            Glob.receivenotification = true;
...
//                    .setPriority(isHighPriority ? Notification.PRIORITY_HIGH : Notification.PRIORITY_DEFAULT)
