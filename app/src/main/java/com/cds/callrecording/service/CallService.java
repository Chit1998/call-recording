package com.cds.callrecording.service;


import static android.content.Intent.FLAG_ACTIVITY_NEW_TASK;
import static android.view.View.GONE;
import static android.view.View.VISIBLE;
import static com.cds.callrecording.Glob.iscounttime;
import static com.cds.callrecording.Glob.isConference;
import static com.cds.callrecording.Glob.isONOffSpeaker;
import static com.cds.callrecording.Glob.isbluetoothconnect;
import static com.cds.callrecording.Glob.isbluetoothconnect_new;
import static com.cds.callrecording.Glob.isconfere;
import static com.cds.callrecording.Glob.iscounttime;
import static com.cds.callrecording.Glob.iscoutnew;
//import static com.cds.callrecording.Utils.CallUtils.callMain;
//import static com.cds.callrecording.Utils.CallUtils.secondaryCall;
//import static com.cds.callrecording.activity.CallActivity.callActivity;
//import static com.cds.callrecording.activity.CallActivity.call_status_label;
//import static com.cds.callrecording.activity.CallActivity.imgPhotouri;
//import static com.cds.callrecording.activity.CallActivity.ivHold;
//import static com.cds.callrecording.activity.CallActivity.iv_addCall;
//import static com.cds.callrecording.activity.CallActivity.ll_call_holder;
//import static com.cds.callrecording.activity.CallActivity.relAddCall;
//import static com.cds.callrecording.activity.CallActivity.relMergeCall;
//import static com.cds.callrecording.activity.CallActivity.rel_add_people;
//import static com.cds.callrecording.activity.CallActivity.tvaddCall;
//import static com.cds.callrecording.activity.CallActivity.txtName;
//import static com.cds.callrecording.activity.CallActivity.txt_hold_number;
...
//import com.cds.callrecording.Utils.CallStateManager;
import com.cds.callrecording.Glob;
import com.cds.callrecording.R;
import com.cds.callrecording.Utils.ContactHelper;
import com.cds.callrecording.Utils.CallerHelper;
import com.cds.callrecording.Utils.TelecomUtils;
//import com.cds.callrecording.Utils.CallUtils;
import com.cds.callrecording.Utils.NotificationUtils;
...
//            intent.setClass(getApplicationContext(), CallActivity.class);
            ...
            boolean isScreenOn = ((PowerManager) getApplicationContext().getSystemService(Context.POWER_SERVICE)).isScreenOn();
            if (((KeyguardManager) getApplicationContext().getSystemService(Context.KEYGUARD_SERVICE)).isKeyguardLocked()) {
        ...
        } else if (call.getState() == Call.STATE_CONNECTING && !isForeground(getApplicationContext().getPackageName())) {
